...
Este repositorio contiene el **frontend de FitoPrice**, una plataforma que permite comparar precios de insumos agrícolas entre diferentes proveedores. Contiene tambien un menu de control par el administrador.
