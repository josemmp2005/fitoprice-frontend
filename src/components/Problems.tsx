/**
 * Component to display the main problems faced by farmers due to lack of price transparency.
 */

import { Card, CardHeader, CardTitle, CardDescription } from "@/components/ui/card"; // Componentes de la UI
import { DollarSign, FileText, TrendingDown } from "lucide-react"; // Iconos

// Definition of the problems array
const problems = [
    {
        icon: DollarSign,
