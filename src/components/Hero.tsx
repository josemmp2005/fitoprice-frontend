...
export default function Hero() {
    ...
    return (
        <section className="mt-50 [@media(min-width:2920px)]:mt-0 h-screen flex flex-col justify-center items-center gap-10">
            ...
            <img src={heroImg} alt="Hero" className="mt-10 rounded-xl w-9/10 mx-auto [mask-image:linear-gradient(to_bottom,black_40%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,black_40%,transparent_90%)] animate-fade-in-custom-delay-1200" />
        </section>
    )
}